...
class SpatialFoundationTest(unittest.TestCase):
    def setUp(self):
        ...
        main.ensure_campus_state_table(connection)
        main.ensure_space_system(connection)
        main.ensure_external_information_system(connection)
        main.ensure_world_runtime_tables(connection)
        connection.commit()
        connection.close()
